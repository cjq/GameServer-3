...
void PluginManager::AddModule(const std::string& strModuleName, IModule* pModule)
{
...
void PluginManager::RemoveModule(const std::string& strModuleName)
{
...
IModule* PluginManager::FindModule(const std::string& strModuleName)
{
    ModuleInstanceMap::iterator it = mModuleInstanceMap.find(strModuleName);
    if (it != mModuleInstanceMap.end())
    {
...
// bool PluginManager::ReInitialize()
// {
    // PluginInstanceMap::iterator itBeforeInstance = mPluginInstanceMap.begin();
    // for (itBeforeInstance; itBeforeInstance != mPluginInstanceMap.end(); itBeforeInstance++)
    // {
...
// void PluginManager::HandlerEx(const NFIActorMessage& message, const Theron::Address from)
// {
//     //添加到队列，每帧执行
//     mxQueue.Push(message);
// }

// bool PluginManager::ExecuteEvent()
// {
...
// void PluginManager::AddComponent(const std::string& strComponentName, NFIComponent* pComponent)
// {
...
// void PluginManager::RemoveComponent(const std::string& strComponentName)
// {
...
// NFIComponent* PluginManager::FindComponent(const std::string& strComponentName)
// {
//     ComponentInstanceMap::iterator it = mComponentInstanceMap.find(strComponentName);
//     if (it != mComponentInstanceMap.end())
//     {
